...
namespace AzureSQLApp.Controllers
{
    ...
    {
        private readonly AzureSQLAppContext _context;

        public EmployeesController(AzureSQLAppContext context)
        {
            _context = context;
        }
        ...
        {
            var azureSQLAppContext = _context.Employees.Include(e => e.Department);
            return View(await azureSQLAppContext.ToListAsync());
        }
